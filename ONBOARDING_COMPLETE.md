...
3. **Read [docs/GETTING_STARTED.md](docs/GETTING_STARTED.md)** (30-45 min)
   - Run the app
   - Run the tests
   - Understand the flow with code traces
   - Make your first change

4. **Check [docs/QUICKSTART.md](docs/QUICKSTART.md)** (bookmark this!)
...
| [docs/QUICKSTART.md](docs/QUICKSTART.md) | Always | Cheat sheet |
| [docs/GETTING_STARTED.md](docs/GETTING_STARTED.md) | First hour | Hands-on walkthrough |
